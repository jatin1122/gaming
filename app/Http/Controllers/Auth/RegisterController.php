...
class RegisterController extends Controller
{
    ...
    protected function validator(array $data)
    {
        return Validator::make($data, [
            ...
            'username' => 'required|string|min:5|max:15|alpha_dash|unique:users',
            'dob' => 'required|string|date|before:-18 years',
            'country' => ['required', new Country($this->iso3166)],
    ...
    {
        Mail::to($data['email'])->send(new Register($data['first_name']));
